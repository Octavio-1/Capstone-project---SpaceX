...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # If a specific launch site was selected, show the Success vs. Failed counts for the sites
...
@app.callback(Output(component_id='success-pie-chart', component_property='figure'),
                                            Input(component_id='site-dropdown', component_property='value'))                               # If a specific launch site was selected, show the Success vs. Failed counts for the site
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names= 'Launch Site', 
        title='Success rate a for ALL sitess')
        return fig
    else:
...
@app.callback(Output(component_id='success-payload-scatter-chart', component_property='figure'),
                                            ...
                                            Input(component_id="payload-slider", component_property="value"))                               # If a specific launch site was selected, show the Success vs. Failed counts for the site
